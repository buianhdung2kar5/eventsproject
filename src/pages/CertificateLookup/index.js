      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center mb-12 text-center">
          ...
          <p className="text-gray-600 max-w-2xl text-center">
            Nhập mã chứng chỉ hoặc mã sự kiện để tra cứu mã xác minh chứng chỉ
            của bạn
          </p>
        </div>
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 mb-8">
          <form onSubmit={handleSearch} className="space-y-6">
            ...
            <Button type="submit" name="🔍 TRA CỨU" fullWidth={true} />
          </form>
        </div>
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="mt-8 p-4 bg-blue-50 border-l-4 border-blue-500 rounded">
            <p className="text-sm text-blue-800">
              ...
              <code className="bg-blue-100 px-2 py-1 rounded">Events123</code>{' '}
              để thử nghĩa chức năng tra cứu
            </p>
          </div>
        </div>
