export const DetailEvents = [
  // 1. Hội thảo AI 2025
  {
    ...
    aboutEvent: 'Khám phá những xu hướng mới nhất trong lĩnh vực trí tuệ nhân tạo và machine learning. Sự kiện quy tụ các chuyên gia hàng đầu trong ngành. Sinh viên tham dự sẽ nhận chứng chỉ sinh viên 5 tốt.',
    mainContent: [
    ...
    targetAudience: 'Sinh viên các ngành Công nghệ thông tin, Khoa học máy tính, và các bạn quan tâm đến AI',
    benefits: [
  ...
  // 2. Triển lãm Robot Quốc tế
  {
    ...
    aboutEvent: 'Trình diễn các thế hệ robot công nghiệp, y tế và robot dân dụng tiên tiến nhất từ khắp nơi trên thế giới. Cơ hội chiêm ngưỡng công nghệ tự động hóa đột phá.',
    mainContent: [
    ...
    targetAudience: 'Sinh viên ngành Cơ điện tử, Kỹ thuật Tự động hóa, và công chúng yêu thích robot/công nghệ.',
    benefits: [
  ...
  // 3. Startup Summit Việt Nam
  {
    ...
    aboutEvent: 'Diễn đàn thường niên quy tụ các nhà đầu tư, nhà sáng lập và chuyên gia khởi nghiệp. Chia sẻ kinh nghiệm gọi vốn, xây dựng mô hình kinh doanh bền vững và mở rộng thị trường.',
    mainContent: [
    ...
    targetAudience: 'Sinh viên có ý tưởng khởi nghiệp, các nhóm Startup giai đoạn đầu, và những người quan tâm đến đầu tư mạo hiểm.',
    benefits: [
  ...
  // 4. Hội thảo Giáo dục Số
  {
    ...
    speakers: [
      { name: 'PGS. TS. Phạm Việt Đức', title: 'Viện trưởng Viện NC Giáo dục Số' },
      { name: 'Bà Nguyễn Thị Lan', title: 'Chuyên gia Thiết kế học tập' }
    ],
    aboutEvent: 'Thảo luận về ứng dụng công nghệ trong giảng dạy và học tập. Tập trung vào các công cụ AI và nền tảng thực tế ảo (VR/AR) giúp nâng cao chất lượng giáo dục.',
    mainContent: [
    ...
    targetAudience: 'Giáo viên, giảng viên, sinh viên ngành Sư phạm, Công nghệ Giáo dục, và phụ huynh quan tâm.',
    benefits: [
  ...
  // 5. Công nghệ trong Chăm sóc Sức khỏe
  {
    ...
    speakers: [
      { name: 'BS. CKII. Trần Hữu Lộc', title: 'Trưởng khoa Tim mạch BV Chợ Rẫy' },
      { name: 'Ông Mai Thanh Tùng', title: 'CTO MedTech Solutions' }
    ],
    aboutEvent: 'Phân tích vai trò của Big Data, AI và IoT trong chẩn đoán, điều trị và quản lý sức khỏe cộng đồng. Hướng tới y tế thông minh và cá nhân hóa.',
    mainContent: [
    ...
    targetAudience: 'Bác sĩ, dược sĩ, nhân viên y tế, sinh viên ngành Y Dược, Công nghệ sinh học và Công nghệ thông tin.',
    benefits: [
  ...
  // 6. Diễn đàn Blockchain & Fintech 2025
  {
    ...
    aboutEvent: 'Cập nhật các xu hướng Blockchain, DeFi và các giải pháp thanh toán số mới. Thảo luận về khung pháp lý và tiềm năng phát triển của Fintech tại Việt Nam.',
    mainContent: [
    ...
    targetAudience: 'Sinh viên ngành Tài chính, Ngân hàng, CNTT, và các chuyên gia, nhà đầu tư trong lĩnh vực Fintech/Crypto.',
    benefits: [
  ...
  // 7. Hội nghị Năng lượng Xanh
  {
    ...
    speakers: [
      { name: 'TS. Nguyễn Mạnh Hùng', title: 'Giám đốc Viện NL Tái tạo Quốc gia' },
      { name: 'Ông Peter Smith', title: 'Chuyên gia Chiến lược Năng lượng Sạch, UNDP' }
    ],
    aboutEvent: 'Nghiên cứu các giải pháp phát triển năng lượng mặt trời, gió và hydrogen. Đánh giá tác động kinh tế và môi trường của việc chuyển đổi năng lượng tại Việt Nam.',
    mainContent: [
    ...
    targetAudience: 'Sinh viên ngành Môi trường, Năng lượng, Kỹ thuật Điện, đại diện doanh nghiệp và cơ quan quản lý nhà nước.',
    benefits: [
  ...
  // 8. Creative Design Week 2025
  {
    ...
    aboutEvent: 'Tuần lễ sáng tạo dành cho cộng đồng thiết kế, tập trung vào xu hướng UI/UX, thiết kế đa nền tảng và ứng dụng của AI trong sáng tạo nghệ thuật.',
    mainContent: [
    ...
    targetAudience: 'Sinh viên ngành Thiết kế đồ họa, Thiết kế đa phương tiện, UX/UI, và các bạn trẻ đam mê sáng tạo.',
    benefits: [
  ...
  // 9. Cyber Security Vietnam 2025
  {
    ...
    speakers: [
      { name: 'Đại tá Trần Văn Dũng', title: 'Phó Cục trưởng Cục An ninh mạng' },
      { name: 'Ông Mark Davis', title: 'CEO CyberDefense Asia' }
    ],
    aboutEvent: 'Chương trình đào tạo chuyên sâu về các mối đe dọa an ninh mạng hiện đại, kỹ thuật tấn công và phòng thủ mạng. Cập nhật các quy định bảo mật mới nhất.',
    mainContent: [
    ...
    targetAudience: 'Chuyên gia an ninh mạng, Kỹ sư CNTT, sinh viên ngành An toàn thông tin, và quản trị hệ thống.',
    benefits: [
  ...
  // 10. Hội nghị Nông nghiệp Thông minh
  {
    ...
    aboutEvent: 'Trình bày các giải pháp công nghệ cao ứng dụng trong trồng trọt và chăn nuôi. Tập trung vào IoT, AI và Big Data để tối ưu hóa năng suất và giảm thiểu chi phí.',
    mainContent: [
    ...
    targetAudience: 'Nông dân, kỹ sư nông nghiệp, sinh viên ngành Nông học, Công nghệ sinh học và các doanh nghiệp nông nghiệp.',
    benefits: [
