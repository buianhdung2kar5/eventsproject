                    ...
                    <div className="p-8">
                        ...
                        <div className="text-center space-y-6">
                            <div className="border-2 border-dashed border-blue-300 p-6 rounded-lg">
                                ...
                                <p className="text-lg text-gray-700">CHỨNG CHỈ SINH VIÊN 5 TỐT</p>
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-4 text-center">
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold text-gray-800">{certificate.venue}</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold text-gray-800">{certificate.fieldOfStudy}</p>
                                </div>
                            </div>

                            <div className="pt-6 border-t border-gray-200">
                                <p className="text-gray-600 mb-2">Ngày cấp: {certificate.completionDate}</p>
                            ...
                            <div className="flex items-center justify-around pt-6 border-t border-gray-200">
                                <div className="text-center">
                                    ...
                                    <p className="font-semibold mt-2">{certificate.fieldOfStudy}</p>
                                </div>
